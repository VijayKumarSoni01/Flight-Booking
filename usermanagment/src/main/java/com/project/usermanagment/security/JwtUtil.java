...
public class JwtUtil {
    ...
    private String buildToken(
        ...
        ZonedDateTime istIssued = issued.toInstant()
                .atZone(
                        ZoneId.of("Asia/Kolkata"));

        ZonedDateTime istExpiry = expiry.toInstant()
                .atZone(
                        ZoneId.of("Asia/Kolkata"));

        System.out.println(
                "Issued (IST): " + istIssued);

        System.out.println(
                "Expiry (IST): " + istExpiry);
    ...
    public <T> T extractClaim(
            String token,
            Function<? super Claims, ? extends T> resolver) {
